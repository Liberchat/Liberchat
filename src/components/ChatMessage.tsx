    ...
    return (
      <div className="flex gap-1 mt-1 flex-wrap">
        {Object.entries(message.reactions).map(([emoji, users]) => (
          <span key={emoji} className="bg-black/60 border border-red-700 rounded-full px-2 py-0.5 text-sm cursor-pointer select-none flex items-center gap-1 hover:bg-red-700/40"
