...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onJoin }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-black via-red-900 to-black flex items-center justify-center p-2 sm:p-4">
      <div className="w-full max-w-md bg-black/90 rounded-xl shadow-2xl p-4 sm:p-8 border-4 border-red-700 relative flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 w-full">
          <div>
            <label htmlFor="username" className="block text-xs sm:text-sm font-bold text-red-200 mb-2 uppercase tracking-wider">
              Nom de camarade
            </label>
            <input
              type="text"
          ...
          <button
            type="submit"
            className="w-full py-2 bg-gradient-to-r from-red-700 to-black text-white font-bold rounded-lg shadow-lg hover:from-black hover:to-red-700 transition-all text-base sm:text-lg uppercase tracking-widest border-2 border-white"
          >
